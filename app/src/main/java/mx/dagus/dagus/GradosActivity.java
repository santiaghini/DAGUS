...
public class GradosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String urlgrados = "http://34.196.248.31/grados";
        Typeface gothambold = Typeface.createFromAsset(getAssets() , "fonts/gotham_bold.ttf");

        queue = Volley.newRequestQueue(this);

        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, urlgrados, null , new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                Log.d("grados" , response.toString() );
